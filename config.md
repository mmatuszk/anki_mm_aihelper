...
- prompt_version: Optional prompt version string. Defaults to "latest".
...
- The add-on sends your prompt_id to OpenAI as prompt.prompt_id and retries with prompt.id if the API rejects prompt_id.
